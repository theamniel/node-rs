...
test('humanizeDuration', (t) => {
  let duration = humanizeDuration(Timestamp / 1000);
  ...
  duration = humanizeDuration(Timestamp / 1000, 7, true);
  t.true(!!duration);
  t.not(duration, '0');
